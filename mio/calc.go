...
func SaveSeekerPos(seeker io.Seeker) (restore func(), err error) {
	savedOffset := int64(0)
	if savedOffset, err = seeker.Seek(0, io.SeekCurrent); err != nil {
		return nil, err
	}
	return func() {
		_, _ = seeker.Seek(savedOffset, io.SeekStart)
	}, nil
}
